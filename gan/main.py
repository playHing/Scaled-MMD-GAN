...
parser.add_argument('-MMD_lr_scheduler',    default=True, type=str2bool, help='Wheather to use lr scheduler based on 3-sample test')
...
parser.add_argument('-viz_filters',         default=False, type=str2bool, help='True for visualizing first conv filter of the critic')
parser.add_argument('-grad_expectation',    default=0, type=int, help='True for visualizing first conv filter of the critic')
...
parser.add_argument('-d_is_injective',      default=False, type=str2bool, help='Ensures the discriminator network is injective by adding the input to the feature')
parser.add_argument('-clipping_iter',       default=-1, type=int, help='Ensures the discriminator network is injective by adding the input to the feature')
...
parser.add_argument('-dof_dim',             default=1, type=int, help='No of discriminator output features [16]')
parser.add_argument('-gf_dim',              default=64, type=int, help='No of generator channels [64]')
parser.add_argument('-batch_norm',          default=True, type=str2bool, help='Use of batch norm [False] (always False for discriminator if gradient_penalty > 0)')
...
parser.add_argument('-sample_freq',         default=1000, type=int, help="L2 penalty on discriminator features [0.0]")
